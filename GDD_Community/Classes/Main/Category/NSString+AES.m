...
static NSString *const PSW_AES_KEY = @"I8jb59qxzrW2H2BE";
static NSString *const AES_IV_PARAMETER = @"2018040313591229";
@implementation NSString (AES)

- (NSString*)aci_encryptWithAES {
    
    NSString *kkkkk = @"123456";
...
- (NSData *)AES128operation:(CCOperation)operation data:(NSData *)data key:(NSString *)key iv:(NSString *)iv {
    ...
    CCCryptorStatus cryptorStatus = CCCrypt(operation, kCCAlgorithmAES128, ccPKCS7Padding,
